...
class NoteRepositoryTest extends IntegrationBased {
    ...
    @BeforeEach
    public void init() {
        NoteEntity the_best_film = new NoteEntity("1", "#films", "The best film", LocalDateTime.of(2023, Month.MARCH, 12, 10, 6));
        noteRepository.save(the_best_film);
        NoteEntity
                the_best_film2 = new NoteEntity("2", "#films", "The best film2", LocalDateTime.of(2022, Month.MARCH, 2, 11, 3));
        noteRepository.save(the_best_film2);
        NoteEntity the_best_game = new NoteEntity("3", "#games", "The best game", LocalDateTime.of(2022, Month.APRIL, 25, 12, 6));
